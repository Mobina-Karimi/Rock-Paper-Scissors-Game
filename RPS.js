...
function RockPaperScissor(e) {
    ...
    function gameOver() {
        ...
        if (confirmAction) {
            ...
            window.close();
            // while (window.open('../RPSEndGame.html')) {
            //     const WhoWon = document.getElementsByClassName('.whoWon');
            //     message.innerHTML === WhoWon; 
            //     if (playerScore > computerScore) {
            //         WhoWon.innerHTML = " Congratulations! You Won the Game";
            //     }
            //     if (playerScore < computerScore) {
            //         WhoWon.innerHTML = " I'm Sorry! Computer Won the Game";
            //     } else {
            //         WhoWon.innerHTML = " Tie! ";
            //     }
            // }
